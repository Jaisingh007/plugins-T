...
async def _(event):
    ...
    if owo in neko_category:
        nobi = await eor(event, f"`Searching {owo} ...`")
        link = nekos.img(owo)
        ...
        nobi = await eor(event, "`Searching randoms...`")
