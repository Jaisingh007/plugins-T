...
@nobi_cmd(pattern="cat$")
async def hmm(nobi):
    reactcat = nekos.textcat()
    await eor(nobi, reactcat)


@nobi_cmd(pattern="why$")
async def hmm(nobi):
    whynobi = nekos.why()
    await eor(nobi, whynobi)


@nobi_cmd(pattern="fact$")
async def hmm(nobi):
    factnobi = nekos.fact()
    await eor(nobi, factnobi)
