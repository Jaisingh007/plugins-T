...
@nobi_cmd(pattern="monster$")
async def _(monster):
    await eor(monster, G)


@nobi_cmd(pattern="pig$")
async def _(pig):
    await eor(pig, H)


@nobi_cmd(pattern="gun$")
async def _(gun):
    await eor(gun, I)


@nobi_cmd(pattern="dog$")
async def _(dog):
    await eor(dog, J)


@nobi_cmd(pattern="Hello$")
async def _(Hello):
    await eor(Hello, K)


@nobi_cmd(pattern="hmf$")
async def _(hmf):
    await eor(hmf, L)


@nobi_cmd(pattern="couple$")
async def _(couple):
    await eor(couple, M)


@nobi_cmd(pattern="sup$")
async def _(supreme):
    await eor(supreme, N)


@nobi_cmd(pattern="india$")
async def _(event):
    await eor(event, O)
...
@nobi_cmd(pattern="snk$")
async def _(snake):
    await eor(snake, Q)


@nobi_cmd(pattern="bye$")
async def _(bye):
    await eor(bye, R)


@nobi_cmd(pattern="shitos$")
async def _(shitos):
    await eor(shitos, S)


@nobi_cmd(pattern="dislike$")
async def _(dislike):
    await eor(dislike, T)
