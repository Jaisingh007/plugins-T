...
async def _(event):
    ...
    animation_chars = [
        ...
        f"`Me: Hello this is` `{nobi_mention}` .Please connect me to Prime Minister",
        "`User Authorised.`",
        "`Calling`  `At +9189*#*#*#56`",
        "`Private  Call Connected...`",
        "`Me: Hello Sir, How are you!!`",
        "`Prime Minister: May I Know Who Is This?`",
        f"`Me: Yes sur, itz me` `{nobi_mention}`",
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1432756163:
            await event.edit(
                "This is My nobi\n**How dare you trying to tell me to kill nobi nigger!**\n\n__Your account is on hold! Pay 99$ to my nobi__ [nobiBoy](https://t.me/Forgo10God) __to release your account__😏"
            )
        else:
