...
@nobi_cmd(pattern="logic$")
async def _(e):
    txt = random.choice(LOGIC)
    await eor(e, txt)


@nobi_cmd(pattern="snow$")
async def _(e):
    txt = random.choice(SNOW)
    await eor(e, txt)


@nobi_cmd(pattern="shayri$")
async def _(e):
    _, _, nobi_mention = await client_id(e)
    txt = random.choice(SHAYRI)
    await eor(e, txt.format(nobi_mention))


@nobi_cmd(pattern="hflirt$")
async def _(e):
    _, _, nobi_mention = await client_id(e)
