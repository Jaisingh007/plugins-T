...
from TelethonNobi.DB.echo_sql import (addecho, get_all_echos, is_echo,
                                      remove_echo)
from TelethonNobi.DB.gvar_sql import addgvar, gvarstat
from TelethonNobi.plugins import *


@nobi_cmd(pattern="echo$")
async def echo(event):
    if event.reply_to_msg_id is not None:
        ForGo10God, nobi_USER, nobi_mention = await client_id(event)
