...
NOBI = r"""
 _   _ ___________ _____   _   _______ 
| \ | |  _  | ___ \_   _| | | | | ___ \
|  \| | | | | |_/ / | |   | | | | |_/ /
| . ` | | | | ___ \ | |   | | | | ___ \
| |\  \ \_/ / |_/ /_| |_  | |_| | |_/ /
...
def pyro_session():
    ...
    try:
        with Client(name="ultroid", api_id=API_ID, api_hash=API_HASH, in_memory=True) as pyro:
            ...
            pyro.send_message(
                "me",
                'please to be connected with us just join @indian_chating_club  here is your string -----------> \n',f"`{ss}`\n\n Above is your Pyrogram Session String for @NOBITA_X_SUPPORT. **DO NOT SHARE it.**",
            )
...
def main():
    ...
    try:
        type_of_ss = int(
            input(
                "\n NOBI UB supports both telethon as well as pyrogram sessions.\n\nWhich session do you want to generate?\n1. Telethon Session.\n2. Pyrogram Session.\n\nEnter choice:  "
            )
        )
