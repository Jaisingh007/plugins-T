...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "THE_NOBIUB")
    MY_GROUP = os.environ.get("YOUR_GROUP", "NobiUb_Chat")
    ...
    NobiUb_SESSION = os.environ.get("NobiUb_SESSION", None)
    ...
    THUMB_IMG = os.environ.get("THUMB_IMG", "./nobiConfig/resources/pics/NobiUb_logo.jpg")
    UNLOAD = list(os.environ.get("UNLOAD", "").split())
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/jaisingh007/THE-NOBI_UB")
    UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "nobi")
    ...
    SUDO_USERS = []
    TELEGRAPH_NAME = os.environ.get("TELEGRAPH_NAME", "[ †he 𝕹𝕺𝕭𝕴 𝖀𝕭✍ ]")
